...
public class HTTPSWebUtilDomi {
    ...
    public String POSTtoFCM(String json) {
        try {
            ...
            connection.setRequestProperty("Authorization", "key=AAAAjo_3vA4:APA91bE-69eVH7odJplYUvZFv4mfqKGUqRXCqk8GSVc2RrqQUZ8l0sGF9t5ljeYhsV5HL3aQdVDNQlzFm3GYSVBVFeVZ4ASsWD_57dzAkT0evd3rCo1OIZqd2tRiqyaOdvoQCMZq6DUm");
            connection.setDoInput(true);
            connection.setDoOutput(true);
